...
console.log('Number.typeof方法 ' + `${intVar} ` + `${typeof intVar == 'number'}`)
console.log('Number.typeof方法 ' + `${floatVar} ` + `${typeof floatVar == 'number'}`)
console.log('Number.typeof方法 ' + `${stringVar} ` + `${typeof stringVar == 'number'}`)
console.log('Number.typeof方法 ' + `${nanVar} ` + `${typeof nanVar == 'number'}`)
console.log('Number.typeof方法 ' + `${infinityVar} ` + `${typeof infinityVar == 'number'}`)
console.log('Number.typeof方法 ' + `${nullVar} ` + `${typeof nullVar == 'number'}`)
console.log('Number.typeof方法 ' + `${undefinedVar} ` + `${typeof undefinedVar == 'number'}`)
console.log('Number.typeof方法 ' + `${intVar} ` + `${typeof intVar == 'number'}`)
